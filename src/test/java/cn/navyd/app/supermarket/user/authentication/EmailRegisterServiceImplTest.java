...
public class EmailRegisterServiceImplTest extends BaseMockTest {
  @Mock
  private SecureCodeGenerator generator;
  @Autowired
  private EmailProperties senderEmailProperties;
  private EmailRegisterServiceImpl emailRegisterServiceImpl;
  
  @BeforeEach
  void setup() {
    emailRegisterServiceImpl = new EmailRegisterServiceImpl();
