...
import static cn.navyd.app.supermarket.util.PageUtils.PAGE_NUMBER_MIN_VALUE;
import static cn.navyd.app.supermarket.util.PageUtils.PAGE_SIZE_DEFAULT_VALUE;
import static cn.navyd.app.supermarket.util.PageUtils.PARAM_LAST_ID;
import static cn.navyd.app.supermarket.util.PageUtils.PARAM_PAGE_NUMBER;
import static cn.navyd.app.supermarket.util.PageUtils.PARAM_PAGE_SIZE;
...
public class UserController {
    ...
    @GetMapping
    public ResponseResult<PageVO<UserVO>> getAllUsersByPage(
    ...
    @GetMapping("/{userId}")
    public ResponseResult<UserVO> getUserById(@PathVariable Integer userId) {
